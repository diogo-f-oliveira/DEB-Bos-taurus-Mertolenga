...
par.kap_X     = 0.123174464211959;         free.kap_X     = 0;     units.kap_X = '-';        label.kap_X     = 'digestion efficiency of food to reserve'; % from measured efficiency (Wilk2004 in AndrBlow2004)
par.v         = 0.0494238506117011;             free.v         = 0;     units.v     = 'cm/d';     label.v         = 'energy conductance';
par.kap       = 0.9788657401665134;           free.kap       = 0;     units.kap   = '-';        label.kap       = 'allocation fraction to soma';

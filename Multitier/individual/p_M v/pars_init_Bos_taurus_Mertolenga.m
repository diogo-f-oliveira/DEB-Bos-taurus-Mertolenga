...
par.v         = 0.044718122903749255;             free.v         = 0;     units.v     = 'cm/d';     label.v         = 'energy conductance';
par.kap       = 0.9263673891221446;           free.kap       = 0;     units.kap   = '-';        label.kap       = 'allocation fraction to soma';
par.p_M       = 94.90486559831834;           free.p_M       = 0;     units.p_M   = 'J/d.cm^3'; label.p_M       = '[p_M], vol-spec somatic maint';

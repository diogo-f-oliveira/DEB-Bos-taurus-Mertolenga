...
par.kap_X     = 0.11812673128148826;         free.kap_X     = 0;     units.kap_X = '-';        label.kap_X     = 'digestion efficiency of food to reserve'; % from measured efficiency (Wilk2004 in AndrBlow2004)
par.v         = 0.04669769254753718;             free.v         = 0;     units.v     = 'cm/d';     label.v         = 'energy conductance';

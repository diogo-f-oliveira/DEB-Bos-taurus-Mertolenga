...
par.kap       = 0.9693699976989794;           free.kap       = 0;     units.kap   = '-';        label.kap       = 'allocation fraction to soma';
par.p_M       = 101.42541902378778;           free.p_M       = 0;     units.p_M   = 'J/d.cm^3'; label.p_M       = '[p_M], vol-spec somatic maint';

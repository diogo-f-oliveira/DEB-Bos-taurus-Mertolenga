...
par.v         = 0.045210324551479206;             free.v         = 0;     units.v     = 'cm/d';     label.v         = 'energy conductance';
par.kap       = 0.9788657453657248;           free.kap       = 0;     units.kap   = '-';        label.kap       = 'allocation fraction to soma';

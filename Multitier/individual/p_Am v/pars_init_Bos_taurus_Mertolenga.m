...
% group parameters
par.p_Am      = 4641.307304375265;          free.p_Am      = 0;     units.p_Am = 'J/d.cm^2';  label.p_Am      = 'Surface-specific maximum assimilation rate for females';
...
par.v         = 0.04316568992544725;             free.v         = 0;     units.v     = 'cm/d';     label.v         = 'energy conductance';

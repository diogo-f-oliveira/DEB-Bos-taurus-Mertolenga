...
% group parameters
par.p_Am      = $p_Am;          free.p_Am      = 0;     units.p_Am = 'J/d.cm^2';  label.p_Am      = 'Surface-specific maximum assimilation rate for females';
par.kap_X     = $kap_X;         free.kap_X     = 0;     units.kap_X = '-';        label.kap_X     = 'digestion efficiency of food to reserve'; % from measured efficiency (Wilk2004 in AndrBlow2004)
...
par.del_M     = $del_M;         free.del_M     = 0;     units.del_M = '-';        label.del_M = 'shape coefficient, thorax perimeter';

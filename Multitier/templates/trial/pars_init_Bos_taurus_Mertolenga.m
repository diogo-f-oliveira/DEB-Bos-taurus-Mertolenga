...
% Species parameters
par.p_Am  = $p_Am;       free.p_Am  = 0;   units.p_Am = 'J/d.cm^2';  label.p_Am  = 'Surface-specific maximum assimilation rate for males';
...
par.E_Hx = $E_Hx;   free.E_Hx  = 0;   units.E_Hx = 'J';         label.E_Hx = 'maturity at weaning for females'; 
par.E_Hp = $E_Hp;   free.E_Hp  = 0;   units.E_Hp = 'J';         label.E_Hp = 'maturity at puberty for females'; 
...
par.del_M = $del_M;     free.del_M = 0;   units.del_M = '-';        label.del_M = 'shape coefficent for height at withers';

...
par.kap_X = 0.1160905692141405;     free.kap_X = 0;   units.kap_X = '-';        label.kap_X = 'digestion efficiency of food to reserve'; 
...
par.h_a = 7.161303817798805e-08;    free.h_a   = 0;   units.h_a = '1/d^2';      label.h_a = 'Weibull aging acceleration'; 
par.t_0 = 88.05054864990203;           free.t_0   = 0;   units.t_0 = 'd';          label.t_0 = 'time at start development'; 
par.del_M = 0.2213216905430935;     free.del_M = 0;   units.del_M = '-';        label.del_M = 'shape coefficent for height at withers';

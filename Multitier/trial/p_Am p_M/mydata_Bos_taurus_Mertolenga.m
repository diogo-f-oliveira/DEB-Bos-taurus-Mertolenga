...
tiers.tier_pars = {'p_Am', 'p_M'}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('p_Am', struct('Trial2021', 4312.79501971572), 'p_M', struct('Trial2021', 106.03582321090389));

...
tiers.tier_pars = {'kap',}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('kap', struct('Trial2021', 0.9263673891221446));

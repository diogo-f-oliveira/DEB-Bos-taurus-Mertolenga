...
tiers.tier_pars = {'v',}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('v', struct('Trial2021', 0.0494238506117011));

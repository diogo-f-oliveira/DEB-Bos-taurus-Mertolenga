...
tiers.tier_pars = {'p_Am', 'kap'}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('p_Am', struct('Trial2021', 4312.79501971572), 'kap', struct('Trial2021', 0.9263673891221446));

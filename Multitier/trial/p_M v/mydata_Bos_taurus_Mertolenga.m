...
tiers.tier_pars = {'p_M', 'v'}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('p_M', struct('Trial2021', 106.03582321090389), 'v', struct('Trial2021', 0.0494238506117011));

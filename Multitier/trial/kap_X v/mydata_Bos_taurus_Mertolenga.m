...
tiers.tier_pars = {'kap_X', 'v'}; units.tiers.tier_pars = '-'; label.tiers.tier_pars = 'Tier parameters'; 
...
metaData.tier_par_init_values = struct('kap_X', struct('Trial2021', 0.1160905692141405), 'v', struct('Trial2021', 0.0494238506117011));

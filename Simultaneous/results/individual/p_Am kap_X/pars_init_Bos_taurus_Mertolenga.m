...
% Breed parameters
par.p_Am  = 3826.0;      free.p_Am  = 1;   units.p_Am = 'J/d.cm^2';  label.p_Am  = 'Surface-specific maximum assimilation rate for males';
...
par.E_G   = 7829.0;       free.E_G   = 1;   units.E_G = 'J/cm^3';     label.E_G = '[E_G], spec cost for structure'; 
...
par.t_0   = 80.0;       free.t_0   = 1;   units.t_0 = 'd';          label.t_0 = 'time at start development'; 
par.del_M = 0.154;     free.del_M = 1;   units.del_M = '-';        label.del_M = 'shape coefficent for height at withers';

% females
par.p_Am_f  = 3469.0;  free.p_Am_f  = 1;   units.p_Am_f = 'J/d.cm^2';  label.p_Am_f = 'Surface-specific maximum assimilation rate for females';
